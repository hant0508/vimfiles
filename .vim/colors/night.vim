...
hi TabLine		  term=bold,reverse  cterm=none ctermfg=darkgreen ctermbg=234 gui=bold guifg=blue guibg=white
hi TabLineFill	  term=bold,reverse  cterm=none ctermfg=white ctermbg=234 gui=bold guifg=blue guibg=white
hi TabLineSel	  term=reverse	ctermfg=darkgreen ctermbg=238 guifg=white guibg=blue
